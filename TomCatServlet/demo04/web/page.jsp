    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${page.list}" var="contact">
            <tr>
                ...
                <td>${contact.email}</td>
                <td>
                    <a class="btn btn-default btn-sm" href="big?action=upcontact&id=${contact.id}&name=${contact.name}">修改</a>&nbsp;
        ...
        <script>
            ...
            function del(id,name) {
                ...
                if (flag) {
                    ...
                    location.href = "big?action=delcontact&id="+id+"&name="+name;
                }
            }
        </script>
        <%--<tr>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <c:if test="${page.curPage != 1}">
                            <li>
                                    <%--上一页是当前页-1--%>
                                <a href="big?action=pagecontact&curPage=${page.curPage - 1}" aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${page.totalPage}" var="i">
                            ...
                            <c:if test="${page.curPage != i}">
                                <li><a href="big?action=pagecontact&curPage=${i}">${i}</a></li>
                            </c:if>
                        </c:forEach>
                        <%--下一页的小图标
                        ...
                        <c:if test="${page.curPage != page.totalPage}">
                            <li>
                                    <%--下一页是当前页+1--%>
                                <a href="big?action=pagecontact&curPage=${page.curPage + 1}" aria-label="Next">
